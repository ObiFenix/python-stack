...
languages = ['English','Chinese','Franch','Japanese','Pyhon','JavaScript','PHP','Alien Language?']
locations = ['Dallas','Center of Sahara','Some Corner within Galaxy','Your granma\'s hug','bottle in the TRASH can']
